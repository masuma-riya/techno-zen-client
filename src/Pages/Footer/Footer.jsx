      ...
      <div className="container mx-auto flex flex-wrap justify-between">
        ...
        <div className="w-full sm:w-1/2 md:w-1/4 lg:w-1/6 px-4 mb-4">
          ...
          <ul>
            ...
            <li>
              <a className="block hover:text-gray-300">FAQ</a>
            </li>
          </ul>
        </div>
        {/* Colonne 4 */}
        <div className="w-full sm:w-1/2 md:w-1/4 lg:w-1/6 px-4 mb-4">
          ...
          <ul>
            <li className="flex align-items">
              ...
              <a className="block hover:text-gray-300 ml-2">Facebook</a>
            </li>
            <li className="flex align-items">
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              <a className="block hover:text-gray-300 ml-2">Twitter</a>
            </li>
            <li className="flex align-items">
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              <a className="block hover:text-gray-300 ml-2">Instagram</a>
            </li>
          </ul>
        </div>
      </div>
