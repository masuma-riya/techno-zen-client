      ...
      <div className="grid gap-8">
        ...
        >
          <div className="border-[20px] border-transparent rounded-[20px] dark:bg-gray-900 bg-white shadow-lg xl:p-10 2xl:p-10 lg:p-10 md:p-10 sm:p-2 m-2">
            <h1 className="mb-6 pb-2 italic font-semibold text-gray-700 text-4xl text-center cursor-default">
            ...
            <div className="flex flex-col mt-10 items-center justify-center font-semibold italic text-xl">
