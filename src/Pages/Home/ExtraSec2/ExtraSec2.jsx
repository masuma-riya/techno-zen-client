    ...
    <div className="">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 xl:px-6">
        <div className="md:w-2/3 lg:w-1/2 mt-12 text-gray-100">
          ...
          <h2 className="text-2xl mb-5 mt-3 font-bold text-black md:text-4xl">
            Our Users Work
          </h2>
          <p className="text-gray-500 mb-4 text-lg font-medium italic">
            They have built many Products and some of them are below
          </p>
        </div>
