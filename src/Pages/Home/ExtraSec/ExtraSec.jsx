const ExtraSec = () => {
  return (
    <div className="h-full mt-24 w-full pt-12 p-4">
      <div className="grid gap-14 md:grid-cols-3 md:gap-5">
        <div className="rounded-xl bg-white p-6 text-center shadow-xl">
          ...
          <p className="px-4 text-gray-500">
            Dive into the realm of artificial intelligence with our curated
            selection of AI tools. From machine learning algorithms to natural
        ...
        <div className="rounded-xl bg-white p-6 text-center shadow-xl">
          ...
          <p className="px-4 text-gray-500">
            Explore a diverse range of web applications tailored to different
            needs and industries. From project management tools to collaborative
